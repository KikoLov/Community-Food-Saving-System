<template>
  <div>
          ...
          <div class="col-4" v-for="merchant in merchantList" :key="merchant.merchantId">
            <div class="card merchant-card">
              ...
              <div class="merchant-actions">
                <button class="btn btn-outline-success btn-sm" @click="openReviews(merchant)">查看评价</button>
                <button class="btn btn-secondary btn-sm" @click="goMerchantDetail(merchant.merchantId)">查看详情</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card mb-3" v-for="merchant in merchantSections" :key="merchant.merchantId">
          <div class="card-header d-flex justify-between align-center">
            ...
            <div class="d-flex align-center" style="gap: 10px;">
              ...
              <button class="btn btn-outline-success btn-sm" @click="openReviews(merchant)">查看评价</button>
              <button class="btn btn-secondary btn-sm" @click="goMerchantDetail(merchant.merchantId)">查看商家详情</button>
            </div>
          </div>
          <div class="row">
    ...
    <MerchantReviewsPanel
      ...
      :merchant-id="reviewTarget.merchantId"
      :merchant-name="reviewTarget.merchantName"
